...
export default function ShareCard({ result }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-2xl border-2 border-emerald-200 bg-gradient-to-br from-emerald-50 to-white p-6 text-center shadow-sm">
        ...
        {topRec && (
          <div className="bg-white rounded-xl border border-emerald-100 px-4 py-3 text-left">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <button
          ...
          disabled={loading}
          className="flex-1 flex items-center justify-center gap-2 rounded-xl bg-[#25D366] hover:bg-[#1fba58] text-white font-medium py-3 px-4 text-sm transition-colors disabled:opacity-50 min-h-[44px]"
        >
        ...
        <button
          ...
          disabled={loading}
          className="flex-1 flex items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white hover:bg-gray-50 text-gray-700 font-medium py-3 px-4 text-sm transition-colors disabled:opacity-50 min-h-[44px]"
        >
          {copied ? (
            <>
